...
# How to takle large problem 
# 1. Breakdown the large problem into small problem : so that you can takle the problem one by one.
# 2. start with easiest 
# 3. Turn the problem into comments
# 4. write the code > run the code > fix the code : repeate cycle till to get right code
# 5. Take next task. 
